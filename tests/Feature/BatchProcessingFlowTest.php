...
class BatchProcessingFlowTest extends TestCase
{
    ...
    public function test_it_processes_a_full_batch()
    {
        ...
        Pool::factory()->create(['id' => 1, 'pool_size' => 5, 'status' => 'batched']);
        Pool::factory()->create(['id' => 2, 'pool_size' => 5, 'status' => 'batched']);
        Pool::factory()->create(['id' => 3, 'pool_size' => 5, 'status' => 'batched']);
