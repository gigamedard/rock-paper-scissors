...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pools', function (Blueprint $table) {
            ...
            $table->enum('status', ['from_blockchain_running', 'from_server_waitting', 'from_server_running','batched', 'from_server_finished'])->default('from_blockchain_running'); // Added status field
            $table->timestamps();
        });
    }
