// config.js (Le nouveau fichier de configuration unique)
import Battlepool from "battlepool/ignition/modules/Battlepool";
...
export const PAYMENT_WALLET_PK = "***REMOVED***"; // Clé privée pour les paiements (Fuji)
...
export const contracts = {
    ...
    // --- Contrat de PAIEMENT (de makePayment.js) ---
    payment: {
        address: "0x7b5655B69546A9E630397985D2Ac3bb23932B910", // <--- Adresse de ton contrat de paiement
        abi: [
                    {
                        "inputs": [],
                        "stateMutability": "nonpayable",
