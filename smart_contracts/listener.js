...
import { contractAddress, privateKey, alchemyUrl, abi } from "../smart_contracts/config.js"; // Import configuration
...
const interSC1 = new Contract(contractAddress, abi, wallet);
async function main() {
